...
public class RunSimulation {
    ...
    public RunSimulation() {
        inputNetworkFile = "C:/3.Usman/MATSim_Islamabad/MATSimIsl/src/java/resources/input/matsimNetwork.xml.gz";
    ...
    public void runMatsim() {
        ...
        // Global
        config.global().setCoordinateSystem("EPSG:32643");
...
//        populationReader.readFile(plansFile);
        ...
        // to write the population file
//        PopulationWriter populationWriter = new PopulationWriter(population);
//        populationWriter.write("input/plans1.xml");
